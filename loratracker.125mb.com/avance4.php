...
<head>
<meta charset="utf-8" />         
<title>Ubicacion del nodo </title> 
...
<option value="water">Rastreador1</option>  
<option value="building">Rastreador2</option>
</select>
</fieldset>
<fieldset>
<label id="Textradio"> Escribir radio</label>
<input type="text" id="info" value="10"> 
<label>  </label>
<input type="button" id="confirmar" value="Aceptar" onClick="myfunction();" /> 
</fieldset>
<fieldset>
...
<fieldset>
<fieldset>
<label id="Textcentro">Confirmar nuevo centro</label>
<input type="button" id="CentroAreaid" value="Aceptar"; /> 
</fieldset>
</div>
</div>
...
document.getElementById('swatches').value="Aceptar";
